        ...
        <div className="flex flex-col gap-4">
          ...
          <PlainBox>
            <div className="flex flex-col gap-2">
              <p className="-mt-1 font-medium text-sm max-[600px]:text-xs text-slate-900 dark:text-white">
                {"📢 "}
                <span className="text-cyan-500 font-bold">주간 클리어 보스</span>
                {" 데이터를 설정하면, 예상 해방 날짜가 계산됩니다."}
              </p>
              <p className="-mt-1 font-medium text-sm max-[600px]:text-xs text-slate-900 dark:text-white">
                {"📢 "}
                <span className="text-cyan-500 font-bold">미션 클리어 당시 파티 인원</span>
